...
/* test sur le constitué */
    ...
    if(strcmp(mot, "start_prog")==0){
        printf("%s ===> STARTP_TOKEN\n",mot);
        temp->cls=STARTP_TOKEN;
    }else if (strcmp(mot, "declar_var")==0){
        printf("%s ===> VAR_TOKEN\n",mot);
        temp->cls=VAR_TOKEN;
        ...
        printf("%s ===> FOR_TOKEN\n",mot);
        temp->cls=FOR_TOKEN;
    }else if (strcmp(mot, "put_in")==0){
        printf("%s ===> PUT_TOKEN\n",mot);
        temp->cls=PUT_TOKEN;
    }else if (strcmp(mot, "print_out")==0){
        printf("%s ===> PRINT_TOKEN\n",mot);
        temp->cls=PRINT_TOKEN;
    }else if (strcmp(mot, "return")==0){
        printf("%s ===> RETURN_TOKEN\n",mot);
        temp->cls=RETURN_TOKEN;
    }else if (strcmp(mot, "end_prog")==0){
        printf("%s ===> ENDPROG_TOKEN\n",mot);
        temp->cls=ENDPROG_TOKEN;
...
/* conversion des valeurs du enum créé en chaine de caractère */
    ...
    case 0: return "STARTP_TOKEN";break;
